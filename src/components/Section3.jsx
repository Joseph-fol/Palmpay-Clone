    ...
    <>
        <section className='section2-content bg-white'>
                ...
                <div className='textSection'>
                    ...
                    <p className='section-highlight-text lh-base text-end ps-5'>You work hard for your money. We work just as hard for you. Pick from <span style={{color: "#8f00ff"}}>flexible and fixed plans</span>  to help you reach your goals faster.</p>
                    </div>
